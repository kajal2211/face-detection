...
window = tk.Tk()
window.title("Face Recognization Attendance System")

window.geometry('18000x900')
window.configure(background='darkseagreen4')
...
def manually_fill():
    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            ENR = tk.Label(MFW, text="Enter Enrollment No", width=15, height=2, fg="white", bg="blue2",
                           font=('times', 15, ' bold '))
...
###for choose subject and fill attendance      ###LBPH  HARCASCADE
def subjectchoose():
    def Fillattendances():
        sub=tx.get()
...
message = tk.Label(window, text="Face Mask Detection System", bg="white", fg="black", width=58,
...
lbl = tk.Label(window, text="Enter Enrollment No", width=20, height=3, fg="black", bg="white", font=('times', 15, ' bold '))
...
AP = tk.Button(window, text="Check Registered students",command=admin_panel,fg="black"  ,bg="alice blue"  ,width=20 ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
AP.place(x=990, y=500)

takeImg = tk.Button(window, text="Take Images",command=take_img,fg="black"  ,bg="alice blue"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
takeImg.place(x=90, y=500)

trainImg = tk.Button(window, text="Train Images",fg="black",command=trainimg ,bg="alice blue"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
